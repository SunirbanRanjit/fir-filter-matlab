...
play_button = uibutton(fig, 'Position', [100 100 50 50], 'Text', 'Play 2', 'ButtonPushedFcn', @play_audio);
pause_button = uibutton(fig, 'Position', [200 100 50 50], 'Text', 'Play 1', 'ButtonPushedFcn', @pause_audio);
